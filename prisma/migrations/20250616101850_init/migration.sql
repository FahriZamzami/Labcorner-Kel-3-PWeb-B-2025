...
-- AddForeignKey
ALTER TABLE `praktikum` ADD CONSTRAINT `praktikum_lab_id_fkey` FOREIGN KEY (`lab_id`) REFERENCES `lab`(`id_lab`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `tugas` ADD CONSTRAINT `tugas_dibuat_oleh_fkey` FOREIGN KEY (`dibuat_oleh`) REFERENCES `user`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
